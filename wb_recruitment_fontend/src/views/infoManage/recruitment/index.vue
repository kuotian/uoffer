    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['bus:recruitment:del']">删除
            </el-button>
          </el-col>
        </el-row>
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="招聘职位" align="center" prop="position"/>
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                v-hasPermi="['bus:recruitment:query']"
              >查看</el-button>
              <el-button
                size="mini"
                type="text"
                ...
                v-hasPermi="['bus:recruitment:edit']"
              >修改</el-button>
              <el-button
                size="mini"
                type="text"
                ...
                v-hasPermi="['bus:recruitment:del']"
              >删除</el-button>
            </template>
          </el-table-column>
        </el-table>
...
<!-- 查看用户详情对话框 -->
<el-dialog :visible.sync="userInfo" title="查看招聘详情"  append-to-body>
      <el-row :gutter="15">
        <el-form :model="form" :rules="rules" size="medium" label-width="100px">
          <el-col :span="24">
            <el-form-item label="公司名" prop="entName">
              <el-input v-model="form.entName" placeholder="请输入公司名" clearable :style="{width: '100%'}" disabled>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="职位" prop="position">
              <el-input v-model="form.position" placeholder="请输入职位" clearable :style="{width: '100%'}" disabled>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="24">
            <el-form-item label="任职要求" prop="jobRequirements">
              <el-input v-model="form.jobRequirements" type="textarea" placeholder="请输入任职要求"
          ...
          <el-col :span="24">
            <el-form-item label="公司信息" prop="entInfo">
              <el-input v-model="form.entInfo" type="textarea" placeholder="请输入公司信息"
                :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="公司地址" prop="entAddress">
              <el-input v-model="form.entAddress" placeholder="请输入公司地址" clearable
   ...
   <el-dialog :visible.sync="updateOpen" title="修改招聘信息">
      <el-row :gutter="15">
        <el-form :model="form" :rules="rules" size="medium" label-width="100px">
          <el-col :span="24">
            <el-form-item label="公司名" prop="entName">
              <el-input v-model="form.entName" placeholder="请输入公司名" clearable :style="{width: '100%'}">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="职位" prop="position">
              <el-input v-model="form.position" placeholder="请输入职位" clearable :style="{width: '100%'}">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
import { list, getById, delById, update, getRecruitmentInfoComment, getRecruitmentInfoClick, getRecruitmentInfoFocus } from "@/api/recruitment";
...
export default {
  ...
  methods: {
    ...
    handleGetUserInfo(row){
      ...
      this.userInfo = true;
      getRecruitmentInfoComment(id).then(res => {
        this.commentList = res.data
      })
       getRecruitmentInfoClick(id).then(res => {
        this.clickList = res.data
      })
       getRecruitmentInfoFocus(id).then(res => {
