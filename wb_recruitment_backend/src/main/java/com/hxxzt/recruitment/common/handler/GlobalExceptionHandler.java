package com.hxxzt.recruitment.common.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResultVo handleException(Exception e) {
        ...
        return ResultVo.failed(500, "系统内部异常");
    }
    ...
    public ResultVo validExceptionHandler(BindException e) {
        ...
        return ResultVo.failed(400, message.toString());
    ...
    public ResultVo handleUnauthorizedException(Exception e) {
        ...
        return ResultVo.failed(401, e.getMessage());
    }


    @ExceptionHandler(value = PenintException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResultVo handleParamsInvalidException(PenintException e) {
        log.error("系统错误：{}", e.getMessage());
        return ResultVo.failed(500, e.getMessage());
    }

    @ExceptionHandler(value = PenintTokenException.class)
    public ResultVo handleTokenInvalidException(PenintTokenException e) {
        log.error("系统错误：{}", e.getMessage());
        return ResultVo.failed(401, e.getMessage());
    }
}
