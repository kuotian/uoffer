<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="isVisible" label="是否可见" :formatter="formatBoolean" width="80px"></el-table-column>
      <el-table-column prop="isLink" label="是否外链" :formatter="formatBoolean" width="80px"></el-table-column>
